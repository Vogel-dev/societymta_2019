...
local rzeczy = {
	...
	{"Kotlet Schabowy", "", 30, 51, 1},
	{"Pasta Gringciosso", "", 23, 39, 2},
	{"Pizza Gringolonni", "", 36, 65, 3},
	{"Gringamisu", "", 9, 18, 7},
	{"Gringola", "", 4, 15, 6},
}

function gui()
	dxDrawImage(screenW * 0.3581, screenH * 0.2721, screenW * 0.2846, screenH * 0.4557, ":smta_base_eats_restrautrant/gfx/bg.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
    ...
    for i, v in ipairs(rzeczy) do
    	...
    	local dodatekY2 = (146*py)*(i-1)
        	...
        	dxDrawImage(screenW * 0.5757, screenH * 0.3477, screenW * 0.0485, screenH * 0.0339, ":smta_base_eats_restrautrant/gfx/button_on.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        else
        	dxDrawImage(screenW * 0.5757, screenH * 0.3477, screenW * 0.0485, screenH * 0.0339, ":smta_base_eats_restrautrant/gfx/button_off.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        end
			if mysz(screenW * 0.5757, screenH * 0.4258, screenW * 0.0485, screenH * 0.0339) then
        	dxDrawImage(screenW * 0.5757, screenH * 0.4258, screenW * 0.0485, screenH * 0.0339, ":smta_base_eats_restrautrant/gfx/button_on.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        else
        	dxDrawImage(screenW * 0.5757, screenH * 0.4258, screenW * 0.0485, screenH * 0.0339, ":smta_base_eats_restrautrant/gfx/button_off.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        end
			if mysz(screenW * 0.5757, screenH * 0.5039, screenW * 0.0485, screenH * 0.0339) then
        	dxDrawImage(screenW * 0.5757, screenH * 0.5039, screenW * 0.0485, screenH * 0.0339, ":smta_base_eats_restrautrant/gfx/button_on.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        else
        	dxDrawImage(screenW * 0.5757, screenH * 0.5039, screenW * 0.0485, screenH * 0.0339, ":smta_base_eats_restrautrant/gfx/button_off.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        end
			if mysz(screenW * 0.5757, screenH * 0.5807, screenW * 0.0485, screenH * 0.0339) then
        	dxDrawImage(screenW * 0.5757, screenH * 0.5807, screenW * 0.0485, screenH * 0.0339, ":smta_base_eats_restrautrant/gfx/button_on.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        else
        	dxDrawImage(screenW * 0.5757, screenH * 0.5807, screenW * 0.0485, screenH * 0.0339, ":smta_base_eats_restrautrant/gfx/button_off.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        end
			if mysz(screenW * 0.5757, screenH * 0.6602, screenW * 0.0485, screenH * 0.0339) then
        	dxDrawImage(screenW * 0.5757, screenH * 0.6602, screenW * 0.0485, screenH * 0.0339, ":smta_base_eats_restrautrant/gfx/button_on.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        else
        	dxDrawImage(screenW * 0.5757, screenH * 0.6602, screenW * 0.0485, screenH * 0.0339, ":smta_base_eats_restrautrant/gfx/button_off.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        end
   	end
end
