...
function gsluzby()
	dxDrawImage(screenW * 0.3821, screenH * 0.2604, screenW * 0.2365, screenH * 0.4805, ":smta_factions_SAMC/bg.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
...
function gbagaznik()
    dxDrawImage(screenW * 0.3638, screenH * 0.3411, screenW * 0.2731, screenH * 0.3190, ":smta_factions_SAMC/bg3.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
