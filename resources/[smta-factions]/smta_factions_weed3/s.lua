...
addEventHandler("daj:Weed3", root, function()
	local cena = math.random(140, 240)
	...
	exports["smta_base_notifications"]:noti("Za sprzedaż 1g marichuany otrzymujesz "..cena.." $", source)
	exports["smta_base_discord"]:connectWeb("["..discordczas.hour..":"..discordczas.minute.."] **WEED** "..getPlayerName(client).." //WEED otrzymał "..cena.." $", "logi-prace")
end)