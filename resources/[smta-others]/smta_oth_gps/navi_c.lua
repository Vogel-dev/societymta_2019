...
function namierz(zielx,ziely)
	...
	for i, wegNode in ipairs(gefundenerWeg) do
		if i==1 then
			wegTable[i]={}
			wegTable[i].marker=createMarker(wegNode.x, wegNode.y, wegNode.z,"cylinder",3,255,0,0,0)
			...
			setMarkerColor(wegTable[1].marker, 125, 0, 0, 0)
