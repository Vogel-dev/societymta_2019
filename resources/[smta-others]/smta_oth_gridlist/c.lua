        ...
        if #dxGrid.items > 0 then
            ...
            for index, data in ipairs ( dxGrid.items ) do
                ...
                if data.vis then
                    ...
                    --dxDrawRectangle ( data.x, data.y-5, data.w, data.h+5, tocolor ( 50,50,50,200 ), data.pg );

                    -- Draw the column bar
                    dxDrawRectangle ( data.x, data.y-5, data.w, 33 % data.h, tocolor (25, 175, 131, 255), data.pg );
                    ...
                    if data.se and data.se <= data.r and data.se >= seeFrom and data.se <= seeTo then
                        ...
                        dxDrawRectangle ( data.x, ( 30 % data.h ) + y2, data.w, 23, tocolor ( 25, 175, 131, 255 ), true);
                    end
                    ...
                    local cWidth = 0
                        ...
                        for cIndex, cData in ipairs ( data.i ) do
                            ...
                            if ( ( cWidth + cData.info.width ) <= data.w ) then
                                ...
                                dxDrawText ( cData.info.title, x, data.y-5+1, cData.info.width + x, ( 30 % data.h ) + data.y+1, tocolor ( 0, 0, 0 ), 1, font, "center", "center", false,false,true )
                                dxDrawText ( cData.info.title, x, data.y-5, cData.info.width + x, ( 30 % data.h ) + data.y, tocolor ( 255, 255, 255 ), 1, font, "center", "center", false,false,true )
                                    ...
                                    for iIndex = seeFrom, seeTo do
                                        ...
                                        if cData[iIndex] then
                                         ...
                                         --   if __isMouseInPosition ( data.x, ( 30 % data.h ) + y2, data.w, 20 ) then
                                            ...
                                            -- Draw the item text
                                            dxDrawRectangle ( data.x, ( 30 % data.h ) + y2, data.w, 23, tocolor ( 0, 0, 0, 100), data.pg );
                                            dxDrawText ( colores_gsub(cData[iIndex]["text"]), x+1, y+1, cData.info.width + x+1, ( 30 % data.h ) + y+1, tocolor ( 0, 0, 0 ), 1, fontsmall, "center", "center", false,false,true )
                                            dxDrawText ( cData[iIndex]["text"], x, y, cData.info.width + x, ( 30 % data.h ) + y, tocolor ( 255, 255, 255 ), 1, fontsmall, "center", "center", false,false,true )
                                        end
                                    end
                                end
